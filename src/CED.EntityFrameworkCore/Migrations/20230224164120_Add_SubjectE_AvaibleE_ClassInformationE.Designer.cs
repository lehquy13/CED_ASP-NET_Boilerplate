...
namespace CED.Migrations
{
    ...
    [Migration("20230224164120_Add_SubjectE_AvaibleE_ClassInformationE")]
    partial class AddSubjectEAvaibleEClassInformationE
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CED.ClassInformations.AvailableDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CED.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CED.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CED.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CED.ClassInformations.AvailableDate", b =>
                {
                    b.HasOne("CED.ClassInformations.ClassInformation", null)
