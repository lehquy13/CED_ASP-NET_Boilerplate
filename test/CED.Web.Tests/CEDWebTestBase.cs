...
{
    public abstract class CEDWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CEDWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CEDWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CEDDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CEDDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CEDDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CEDDbContext, Task<T>> func)
        {
            T result;
